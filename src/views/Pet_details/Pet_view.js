  ...
  useEffect(() => {
    if (id) {
      const fetchPetById = async () => {
        ...
        const PetJsonResp = await PetResponse.json();
        setPet(PetJsonResp);
      };
      fetchPetById();
    }
          ...
          <Grid>
            <Grid item lg={12} xs={12}>
              <Box display="flex" justifyContent="space-between">
                <Typography className="page-heading" variant="h5">View Pet</Typography>
